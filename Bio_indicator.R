...
GB <- read.csv(file = 'C:\\Users\\17145\\Documents\\Edx\\Capstone\\Ground_Beetle_Data.csv',header = TRUE)
EN <- read.csv(file = 'C:\\Users\\17145\\Documents\\Edx\\Capstone\\Community_index.csv',header = TRUE)
